<?php
    ...
    /**
     * Class AdmissionApplicationWithdrawalReasonsClient
     *
     * AdmissionApplicationWithdrawalReasonsClient class used to interact with the `admission-application-withdrawal-reasons` data type.
     * Domain: Recruitment
     * Functional Area: Funnel - Applications
     * Model Name: admission-application-withdrawal-reasons
     ...
     */
    class AdmissionApplicationWithdrawalReasonsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/admission-application-withdrawal-reasons';
    }