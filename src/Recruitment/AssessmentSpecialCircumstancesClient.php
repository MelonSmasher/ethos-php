<?php
    ...
    /**
     * Class AssessmentSpecialCircumstancesClient
     *
     * AssessmentSpecialCircumstancesClient class used to interact with the `assessment-special-circumstances` data type.
     * Domain: Recruitment
     * Functional Area: Funnel - Test scores
     * Model Name: assessment-special-circumstances
     ...
     */
    class AssessmentSpecialCircumstancesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/assessment-special-circumstances';
    }