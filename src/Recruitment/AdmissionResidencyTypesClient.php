<?php
    ...
    /**
     * Class AdmissionResidencyTypesClient
     *
     * AdmissionResidencyTypesClient class used to interact with the `admission-residency-types` data type.
     * Domain: Recruitment
     * Functional Area: Funnel - Ratings
     * Model Name: admission-residency-types
     ...
     */
    class AdmissionResidencyTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/admission-residency-types';
    }