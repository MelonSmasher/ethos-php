<?php
    ...
    /**
     * Class CareerGoalsClient
     *
     * CareerGoalsClient class used to interact with the `career-goals` data type.
     * Domain: Recruitment
     * Functional Area: Funnel - Applications
     * Model Name: career-goals
     ...
     */
    class CareerGoalsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/career-goals';
    }