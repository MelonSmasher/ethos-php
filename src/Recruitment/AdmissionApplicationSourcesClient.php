<?php
    ...
    /**
     * Class AdmissionApplicationSourcesClient
     *
     * AdmissionApplicationSourcesClient class used to interact with the `admission-application-sources` data type.
     * Domain: Recruitment
     * Functional Area: Funnel - Sources
     * Model Name: admission-application-sources
     ...
     */
    class AdmissionApplicationSourcesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/admission-application-sources';
    }