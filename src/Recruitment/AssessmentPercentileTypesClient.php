<?php
    ...
    /**
     * Class AssessmentPercentileTypesClient
     *
     * AssessmentPercentileTypesClient class used to interact with the `assessment-percentile-types` data type.
     * Domain: Recruitment
     * Functional Area: Applications - Test Scores
     * Model Name: assessment-percentile-types
     ...
     */
    class AssessmentPercentileTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/assessment-percentile-types';
    }