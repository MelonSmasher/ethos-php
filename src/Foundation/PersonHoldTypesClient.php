<?php
    ...
    /**
     * Class PersonHoldTypesClient
     *
     * PersonHoldTypesClient class used to interact with the `person-hold-types` data type.
     * Domain: Foundation
     * Functional Area: Campus Life - Restrictions/Holds
     * Model Name: person-hold-types
     ...
     */
    class PersonHoldTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/person-hold-types';
    }