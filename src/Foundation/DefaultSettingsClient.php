<?php
    ...
    /**
     * Class DefaultSettingsClient
     *
     * DefaultSettingsClient class used to interact with the `default-settings` data type.
     * Domain: Foundation
     * Functional Area: Configuration - API Settings
     * Model Name: default-settings
     ...
     */
    class DefaultSettingsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/default-settings';
    }