<?php
    ...
    /**
     * Class ConfigurationSettingsOptionsClient
     *
     * ConfigurationSettingsOptionsClient class used to interact with the `configuration-settings-options` data type.
     * Domain: Foundation
     * Functional Area: Configuration - API Settings
     * Model Name: configuration-settings-options
     ...
     */
    class ConfigurationSettingsOptionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/configuration-settings-options';
    }