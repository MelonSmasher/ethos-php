<?php
    ...
    /**
     * Class InterestsClient
     *
     * InterestsClient class used to interact with the `interests` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Interests
     * Model Name: interests
     ...
     */
    class InterestsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/interests';
    }