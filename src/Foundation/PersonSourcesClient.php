<?php
    ...
    /**
     * Class PersonSourcesClient
     *
     * PersonSourcesClient class used to interact with the `person-sources` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Bio
     * Model Name: person-sources
     ...
     */
    class PersonSourcesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/person-sources';
    }