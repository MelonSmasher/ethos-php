<?php
     ...
     * Class SitesClient
     *
     * SitesClient class used to interact with the `sites` data type.
     * Domain: Foundation
     * Functional Area: Facilities - Locations
     * Model Name: sites
     ...
     */
    class SitesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
