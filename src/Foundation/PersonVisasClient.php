<?php
    ...
    /**
     * Class PersonVisasClient
     *
     * PersonVisasClient class used to interact with the `person-visas` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Immigration
     * Model Name: person-visas
     ...
     */
    class PersonVisasClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/person-visas';
    }