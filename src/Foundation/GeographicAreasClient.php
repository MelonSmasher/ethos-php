<?php
    ...
    /**
     * Class GeographicAreasClient
     *
     * GeographicAreasClient class used to interact with the `geographic-areas` data type.
     * Domain: Foundation
     * Functional Area: Advancement - Constituents - GEO Regions
     * Model Name: geographic-areas
     ...
     */
    class GeographicAreasClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/geographic-areas';
    }