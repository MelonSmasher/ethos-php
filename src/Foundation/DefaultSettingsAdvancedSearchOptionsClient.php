<?php
    ...
    /**
     * Class DefaultSettingsAdvancedSearchOptionsClient
     *
     * DefaultSettingsAdvancedSearchOptionsClient class used to interact with the `default-settings-advanced-search-options` data type.
     * Domain: Foundation
     * Functional Area: Configuration - API Settings
     * Model Name: default-settings-advanced-search-options
     ...
     */
    class DefaultSettingsAdvancedSearchOptionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/default-settings-advanced-search-options';
    }