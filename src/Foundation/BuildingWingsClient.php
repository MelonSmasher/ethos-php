<?php
    ...
    /**
     * Class BuildingWingsClient
     *
     * BuildingWingsClient class used to interact with the `building-wings` data type.
     * Domain: Foundation
     * Functional Area: Campus Life - Housing
     * Model Name: building-wings
     ...
     */
    class BuildingWingsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/building-wings';
    }