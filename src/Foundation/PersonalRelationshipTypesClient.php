<?php
    ...
    /**
     * Class PersonalRelationshipTypesClient
     *
     * PersonalRelationshipTypesClient class used to interact with the `personal-relationship-types` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Relationships
     * Model Name: personal-relationship-types
     * Banner Read/Write Support: R
     * Colleague Read/Write Support: R
     * Banner Data Model Versions Supported: 7
     * Colleague Data Model Versions Supported: 6, 7
     *
     ...
     */
    class PersonalRelationshipTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/personal-relationship-types';
    }