<?php
    ...
    /**
     * Class CitizenshipStatusesClient
     *
     * CitizenshipStatusesClient class used to interact with the `citizenship-statuses` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Person
     * Model Name: citizenship-statuses
     ...
     */
    class CitizenshipStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/citizenship-statuses';
    }