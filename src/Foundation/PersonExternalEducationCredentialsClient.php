<?php
    ...
    /**
     * Class PersonExternalEducationCredentialsClient
     *
     * PersonExternalEducationCredentialsClient class used to interact with the `person-external-education-credentials` data type.
     * Domain: Foundation
     * Functional Area: Academic History - External
     * Model Name: person-external-education-credentials
     ...
     */
    class PersonExternalEducationCredentialsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/person-external-education-credentials';
    }