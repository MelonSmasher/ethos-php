<?php
    ...
    /**
     * Class PersonMatchingRequestsClient
     *
     * PersonMatchingRequestsClient class used to interact with the `person-matching-requests` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Person
     * Model Name: person-matching-requests
     ...
     */
    class PersonMatchingRequestsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/person-matching-requests';
    }