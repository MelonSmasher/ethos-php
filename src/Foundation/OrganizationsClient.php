<?php
     ...
     *
     * OrganizationsClient class used to interact with the `organizations` data type.
     * Domain: Foundation
     ...
     */
    class OrganizationsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/organizations';
    }