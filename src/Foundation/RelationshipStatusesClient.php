<?php
    ...
    /**
     * Class RelationshipStatusesClient
     *
     * RelationshipStatusesClient class used to interact with the `relationship-statuses` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Relationships
     * Model Name: relationship-statuses
     ...
     */
    class RelationshipStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/relationship-statuses';
    }