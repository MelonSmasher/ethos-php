<?php
    ...
    /**
     * Class GenderIdentitiesClient
     *
     * GenderIdentitiesClient class used to interact with the `gender-identities` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Bio
     * Model Name: gender-identities
     ...
     */
    class GenderIdentitiesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/gender-identities';
    }