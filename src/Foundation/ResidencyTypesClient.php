<?php
    ...
    /**
     * Class ResidencyTypesClient
     *
     * ResidencyTypesClient class used to interact with the `residency-types` data type.
     * Domain: Foundation
     * Functional Area: Campus Life - Housing
     * Model Name: residency-types
     ...
     */
    class ResidencyTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/residency-types';
    }