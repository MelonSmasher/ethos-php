<?php
    ...
    /**
     * Class RoomsMinimumClient
     *
     * RoomsMinimumClient class used to interact with the `rooms-minimum` data type.
     * Domain: Foundation
     * Functional Area: Facilities - Rooms
     * Model Name: rooms-minimum
     ...
     */
    class RoomsMinimumClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/rooms-minimum';
    }