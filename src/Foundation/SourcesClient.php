<?php
     ...
     * Class SourcesClient
     *
     * SourcesClient class used to interact with the `sources` data type.
     * Domain: Foundation
     * Functional Area: Recruitment - Funnel - Sources
     * Model Name: sources
     ...
     */
    class SourcesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/sources';
    }