<?php
    ...
    /**
     * Class CollectionConfigurationSettingsClient
     *
     * CollectionConfigurationSettingsClient class used to interact with the `collection-configuration-settings` data type.
     * Domain: Foundation
     * Functional Area: Configuration - API Settings
     * Model Name: collection-configuration-settings
     * Banner Read/Write Support: R
     * Colleague Read/Write Support: RU
     ...
     */
    class CollectionConfigurationSettingsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/collection-configuration-settings';
    }