<?php
    ...
    /**
     * Class MealPlanRatesClient
     *
     * MealPlanRatesClient class used to interact with the `meal-plan-rates` data type.
     * Domain: Foundation
     * Functional Area: Campus Life - Meal plans
     * Model Name: meal-plan-rates
     ...
     */
    class MealPlanRatesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/meal-plan-rates';
    }