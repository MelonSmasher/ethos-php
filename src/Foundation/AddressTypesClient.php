<?php
    ...
    /**
     * Class AddressTypesClient
     *
     * AddressTypesClient class used to interact with the `address-types` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Person
     * Model Name: address-types
     ...
     */
    class AddressTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/address-types';
    }