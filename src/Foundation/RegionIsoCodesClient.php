<?php
    ...
    /**
     * Class RegionIsoCodesClient
     *
     * RegionIsoCodesClient class used to interact with the `region-iso-codes` data type.
     * Domain: Foundation
     * Functional Area: Configuration - ISO Code Standards
     * Model Name: region-iso-codes
     ...
     */
    class RegionIsoCodesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/region-iso-codes';
    }