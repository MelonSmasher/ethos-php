<?php
     ...
     *
     * BuildingsClient class used to interact with the `buildings` data type.
     * Domain: Foundation
     * Functional Area: Facilities - Buildings
     ...
     */
    class BuildingsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/buildings';
    }