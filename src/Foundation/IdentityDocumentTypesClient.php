<?php
    ...
    /**
     * Class IdentityDocumentTypesClient
     *
     * IdentityDocumentTypesClient class used to interact with the `identity-document-types` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Identifiers
     * Model Name: identity-document-types
     ...
     */
    class IdentityDocumentTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/identity-document-types';
    }