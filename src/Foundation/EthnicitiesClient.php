<?php
    ...
    /**
     * Class EthnicitiesClient
     *
     * EthnicitiesClient class used to interact with the `ethnicities` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Person
     * Model Name: ethnicities
     ...
     */
    class EthnicitiesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/ethnicities';
    }