<?php
    ...
    /**
     * Class PersonalPronounsClient
     *
     * PersonalPronounsClient class used to interact with the `personal-pronouns` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Bio
     * Model Name: personal-pronouns
     ...
     */
    class PersonalPronounsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/personal-pronouns';
    }