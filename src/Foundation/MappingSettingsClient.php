<?php
    ...
    /**
     * Class MappingSettingsClient
     *
     * MappingSettingsClient class used to interact with the `mapping-settings` data type.
     * Domain: Foundation
     * Functional Area: Configuration - API Settings
     * Model Name: mapping-settings
     ...
     */
    class MappingSettingsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/mapping-settings';
    }