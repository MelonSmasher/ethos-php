<?php
    ...
    /**
     * Class CommentSubjectAreaClient
     *
     * CommentSubjectAreaClient class used to interact with the `comment-subject-area` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Comments
     * Model Name: comment-subject-area
     ...
     */
    class CommentSubjectAreaClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/comment-subject-area';
    }