<?php
    ...
    /**
     * Class CampusOrganizationsClient
     *
     * CampusOrganizationsClient class used to interact with the `campus-organizations` data type.
     * Domain: Foundation
     * Functional Area: Campus Life - Clubs and Organizations
     * Model Name: campus-organizations
     ...
     */
    class CampusOrganizationsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/campus-organizations';
    }