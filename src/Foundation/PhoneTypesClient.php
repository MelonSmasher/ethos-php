<?php
    ...
    /**
     * Class PhoneTypesClient
     *
     * PhoneTypesClient class used to interact with the `phone-types` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Person
     * Model Name: phone-types
     ...
     */
    class PhoneTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/phone-types';
    }