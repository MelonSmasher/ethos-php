<?php
    ...
    /**
     * Class CompoundConfigurationSettingsOptionsClient
     *
     * CompoundConfigurationSettingsOptionsClient class used to interact with the `compound-configuration-settings-options` data type.
     * Domain: Foundation
     * Functional Area: Configuration - API Settings
     * Model Name: compound-configuration-settings-options
     ...
     */
    class CompoundConfigurationSettingsOptionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/compound-configuration-settings-options';
    }