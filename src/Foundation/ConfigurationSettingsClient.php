<?php
    ...
    /**
     * Class ConfigurationSettingsClient
     *
     * ConfigurationSettingsClient class used to interact with the `configuration-settings` data type.
     * Domain: Foundation
     * Functional Area: Configuration - API Settings
     * Model Name: configuration-settings
     * Banner Read/Write Support: RU
     ...
     */
    class ConfigurationSettingsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/configuration-settings';
    }