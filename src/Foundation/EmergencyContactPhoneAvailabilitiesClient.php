<?php
    ...
    /**
     * Class EmergencyContactPhoneAvailabilitiesClient
     *
     * EmergencyContactPhoneAvailabilitiesClient class used to interact with the `emergency-contact-phone-availabilities` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Emergency Info
     * Model Name: emergency-contact-phone-availabilities
     ...
     */
    class EmergencyContactPhoneAvailabilitiesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/emergency-contact-phone-availabilities';
    }