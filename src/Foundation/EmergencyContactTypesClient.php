<?php
    ...
    /**
     * Class EmergencyContactTypesClient
     *
     * EmergencyContactTypesClient class used to interact with the `emergency-contact-types` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Emergency Info
     * Model Name: emergency-contact-types
     ...
     */
    class EmergencyContactTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/emergency-contact-types';
    }