<?php
    ...
    /**
     * Class InterestAreasClient
     *
     * InterestAreasClient class used to interact with the `interest-areas` data type.
     * Domain: Foundation
     * Functional Area: Advancement - Constituents - Philanthropic Interests
     * Model Name: interest-areas
     ...
     */
    class InterestAreasClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/interest-areas';
    }