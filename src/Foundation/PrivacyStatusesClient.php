<?php
    ...
    /**
     * Class PrivacyStatusesClient
     *
     * PrivacyStatusesClient class used to interact with the `privacy-statuses` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Bio
     * Model Name: privacy-statuses
     ...
     */
    class PrivacyStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/privacy-statuses';
    }