<?php
    ...
    /**
     * Class ProficiencyLicensingAuthoritiesClient
     *
     * ProficiencyLicensingAuthoritiesClient class used to interact with the `proficiency-licensing-authorities` data type.
     * Domain: Foundation
     * Functional Area: Demographics - Bio
     * Model Name: proficiency-licensing-authorities
     ...
     */
    class ProficiencyLicensingAuthoritiesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/proficiency-licensing-authorities';
    }