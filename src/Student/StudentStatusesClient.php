<?php
    ...
    /**
     * Class StudentStatusesClient
     *
     * StudentStatusesClient class used to interact with the `student-statuses` data type.
     * Domain: Student
     * Functional Area: Student Profile - Profile
     * Model Name: student-statuses
     ...
     */
    class StudentStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-statuses';
    }