<?php
    ...
    /**
     * Class GradeSchemesClient
     *
     * GradeSchemesClient class used to interact with the `grade-schemes` data type.
     * Domain: Student
     * Functional Area: Academic History - Section grades
     * Model Name: grade-schemes
     ...
     */
    class GradeSchemesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/grade-schemes';
    }