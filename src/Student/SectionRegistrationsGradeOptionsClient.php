<?php
    ...
    /**
     * Class SectionRegistrationsGradeOptionsClient
     *
     * SectionRegistrationsGradeOptionsClient class used to interact with the `section-registrations-grade-options` data type.
     * Domain: Student
     * Functional Area: Registration - Enrollments
     * Model Name: section-registrations-grade-options
     ...
     */
    class SectionRegistrationsGradeOptionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/section-registrations-grade-options';
    }