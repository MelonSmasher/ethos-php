<?php
    ...
    /**
     * Class StudentAcademicPeriodStatusesClient
     *
     * StudentAcademicPeriodStatusesClient class used to interact with the `student-academic-period-statuses` data type.
     * Domain: Student
     * Functional Area: Student Profile - Academic Standing
     * Model Name: student-academic-period-statuses
     ...
     */
    class StudentAcademicPeriodStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-academic-period-statuses';
    }