<?php
    ...
    /**
     * Class StudentCohortsClient
     *
     * StudentCohortsClient class used to interact with the `student-cohorts` data type.
     * Domain: Student
     * Functional Area: Student Profile - Profile
     * Model Name: student-cohorts
     * Banner Read/Write Support: R
     * Colleague Read/Write Support: R
     * Banner Data Model Versions Supported: 7, 7.1.0
     * Colleague Data Model Versions Supported: 6, 7, 7.1.0
     *
     ...
     */
    class StudentCohortsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string|bool
         */
        public $colleagueApiVersion = '7.1.0';
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-cohorts';
    }