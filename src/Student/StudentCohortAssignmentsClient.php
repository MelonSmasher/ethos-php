<?php
    ...
    /**
     * Class StudentCohortAssignmentsClient
     *
     * StudentCohortAssignmentsClient class used to interact with the `student-cohort-assignments` data type.
     * Domain: Student
     * Functional Area: Student Profile - Profile
     * Model Name: student-cohort-assignments
     ...
     */
    class StudentCohortAssignmentsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-cohort-assignments';
    }