<?php
    ...
    /**
     * Class StudentAcademicProgramsReplacementsClient
     *
     * StudentAcademicProgramsReplacementsClient class used to interact with the `student-academic-programs-replacements` data type.
     * Domain: Student
     * Functional Area: Registration - Enrollments
     * Model Name: student-academic-programs-replacements
     ...
     */
    class StudentAcademicProgramsReplacementsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-academic-programs-replacements';
    }