<?php
    ...
    /**
     * Class SectionRegistrationStatusesClient
     *
     * SectionRegistrationStatusesClient class used to interact with the `section-registration-statuses` data type.
     * Domain: Student
     * Functional Area: Registration - Enrollments
     * Model Name: section-registration-statuses
     * Banner Read/Write Support: R
     * Colleague Read/Write Support: R
     * Banner Data Model Versions Supported: 6, 8
     ...
     */
    class SectionRegistrationStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/section-registration-statuses';
    }