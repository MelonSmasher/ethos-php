<?php
    ...
    /**
     * Class SectionRegistrationsClient
     *
     * SectionRegistrationsClient class used to interact with the `section-registrations` data type.
     * Domain: Student
     * Functional Area: Registration - Enrollments
     * Model Name: section-registrations
     * Banner Read/Write Support: CRU
     * Colleague Read/Write Support: CRU
     * Banner Data Model Versions Supported: 6, 7, 16.0.0
     * Colleague Data Model Versions Supported: 6, 7, 16.0.0
     *
     ...
     */
    class SectionRegistrationsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/section-registrations';
    }