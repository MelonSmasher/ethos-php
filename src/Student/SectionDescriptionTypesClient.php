<?php
    ...
    /**
     * Class SectionDescriptionTypesClient
     *
     * SectionDescriptionTypesClient class used to interact with the `section-description-types` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Sections
     * Model Name: section-description-types
     ...
     */
    class SectionDescriptionTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/section-description-types';
    }