<?php
    ...
    /**
     * Class SectionCrosslistsClient
     *
     * SectionCrosslistsClient class used to interact with the `section-crosslists` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Cross-listed sections
     * Model Name: section-crosslists
     ...
     */
    class SectionCrosslistsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/section-crosslists';
    }