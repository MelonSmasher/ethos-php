<?php
    ...
    /**
     * Class StudentAcademicCredentialsClient
     *
     * StudentAcademicCredentialsClient class used to interact with the `student-academic-credentials` data type.
     * Domain: Student
     * Functional Area: Academic History - Academic History
     * Model Name: student-academic-credentials
     ...
     */
    class StudentAcademicCredentialsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-academic-credentials';
    }