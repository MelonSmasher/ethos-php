<?php
    ...
    /**
     * Class AcademicPeriodEnrollmentStatusesClient
     *
     * AcademicPeriodEnrollmentStatusesClient class used to interact with the `academic-period-enrollment-statuses` data type.
     * Domain: Student
     * Functional Area: Student Profile - Profile
     * Model Name: academic-period-enrollment-statuses
     ...
     */
    class AcademicPeriodEnrollmentStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/academic-period-enrollment-statuses';
    }