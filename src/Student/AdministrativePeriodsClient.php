<?php
    ...
    /**
     * Class AdministrativePeriodsClient
     *
     * AdministrativePeriodsClient class used to interact with the `administrative-periods` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Academic periods
     * Model Name: administrative-periods
     ...
     */
    class AdministrativePeriodsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/administrative-periods';
    }