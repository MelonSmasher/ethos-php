<?php
    ...
    /**
     * Class EducationalGoalsClient
     *
     * EducationalGoalsClient class used to interact with the `educational-goals` data type.
     * Domain: Student
     * Functional Area: Student Profile - Profile
     * Model Name: educational-goals
     ...
     */
    class EducationalGoalsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/educational-goals';
    }