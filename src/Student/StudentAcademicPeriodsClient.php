<?php
    ...
    /**
     * Class StudentAcademicPeriodsClient
     *
     * StudentAcademicPeriodsClient class used to interact with the `student-academic-periods` data type.
     * Domain: Student
     * Functional Area: Student Profile - Academic Standing
     * Model Name: student-academic-periods
     ...
     */
    class StudentAcademicPeriodsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-academic-periods';
    }