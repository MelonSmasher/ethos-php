<?php
    ...
    /**
     * Class AccountingCodeCategoriesClient
     *
     * AccountingCodeCategoriesClient class used to interact with the `accounting-code-categories` data type.
     * Domain: Student
     * Functional Area: Account Receivables - Charges
     * Model Name: accounting-code-categories
     ...
     */
    class AccountingCodeCategoriesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/accounting-code-categories';
    }