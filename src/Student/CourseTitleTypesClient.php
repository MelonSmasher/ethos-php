<?php
    ...
    /**
     * Class CourseTitleTypesClient
     *
     * CourseTitleTypesClient class used to interact with the `course-title-types` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Courses
     * Model Name: course-title-types
     ...
     */
    class CourseTitleTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/course-title-types';
    }