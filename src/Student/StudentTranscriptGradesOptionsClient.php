<?php
    ...
    /**
     * Class StudentTranscriptGradesOptionsClient
     *
     * StudentTranscriptGradesOptionsClient class used to interact with the `student-transcript-grades-options` data type.
     * Domain: Student
     * Functional Area: Academic History - Transcripts
     * Model Name: student-transcript-grades-options
     ...
     */
    class StudentTranscriptGradesOptionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-transcript-grades-options';
    }