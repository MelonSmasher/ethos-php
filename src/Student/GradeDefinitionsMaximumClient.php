<?php
    ...
    /**
     * Class GradeDefinitionsMaximumClient
     *
     * GradeDefinitionsMaximumClient class used to interact with the `grade-definitions-maximum` data type.
     * Domain: Student
     * Functional Area: Academic History - Section grades
     * Model Name: grade-definitions-maximum
     * Banner Read/Write Support: 
     ...
     */
    class GradeDefinitionsMaximumClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/grade-definitions-maximum';
    }