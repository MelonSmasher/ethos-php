<?php
    ...
    /**
     * Class GradeModesClient
     *
     * GradeModesClient class used to interact with the `grade-modes` data type.
     * Domain: Student
     * Functional Area: Academic History - Section grades
     * Model Name: grade-modes
     ...
     */
    class GradeModesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/grade-modes';
    }