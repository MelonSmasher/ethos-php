<?php
    ...
    /**
     * Class CourseLevelsClient
     *
     * CourseLevelsClient class used to interact with the `course-levels` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Courses
     * Model Name: course-levels
     ...
     */
    class CourseLevelsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/course-levels';
    }