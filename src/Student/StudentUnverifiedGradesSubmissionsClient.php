<?php
    ...
    /**
     * Class StudentUnverifiedGradesSubmissionsClient
     *
     * StudentUnverifiedGradesSubmissionsClient class used to interact with the `student-unverified-grades-submissions` data type.
     * Domain: Student
     * Functional Area: Academic History - Section grades
     * Model Name: student-unverified-grades-submissions
     ...
     */
    class StudentUnverifiedGradesSubmissionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
