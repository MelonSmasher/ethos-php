<?php
     ...
     *
     * SubjectsClient class used to interact with the `subjects` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Subjects
     * Model Name: subjects
     ...
     */
    class SubjectsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/subjects';
    }