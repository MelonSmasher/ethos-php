<?php
    ...
    /**
     * Class GradeChangeReasonsClient
     *
     * GradeChangeReasonsClient class used to interact with the `grade-change-reasons` data type.
     * Domain: Student
     * Functional Area: Academic History - Section grades
     * Model Name: grade-change-reasons
     ...
     */
    class GradeChangeReasonsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/grade-change-reasons';
    }