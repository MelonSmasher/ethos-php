<?php
    ...
    /**
     * Class StudentTranscriptGradesAdjustmentsClient
     *
     * StudentTranscriptGradesAdjustmentsClient class used to interact with the `student-transcript-grades-adjustments` data type.
     * Domain: Student
     * Functional Area: Academic History - Transcripts
     * Model Name: student-transcript-grades-adjustments
     * Banner Read/Write Support: U
     * Colleague Read/Write Support: U
     ...
     */
    class StudentTranscriptGradesAdjustmentsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-transcript-grades-adjustments';
    }