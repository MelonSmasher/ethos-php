<?php
    ...
    /**
     * Class CourseStatusesClient
     *
     * CourseStatusesClient class used to interact with the `course-statuses` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Courses
     * Model Name: course-statuses
     ...
     */
    class CourseStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/course-statuses';
    }