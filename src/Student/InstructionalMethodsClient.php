<?php
    ...
    /**
     * Class InstructionalMethodsClient
     *
     * InstructionalMethodsClient class used to interact with the `instructional-methods` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Instructional Methods
     * Model Name: instructional-methods
     ...
     */
    class InstructionalMethodsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/instructional-methods';
    }