<?php
    ...
    /**
     * Class CourseCategoriesClient
     *
     * CourseCategoriesClient class used to interact with the `course-categories` data type.
     * Domain: Student
     * Functional Area: Curriculum Management - Courses
     * Model Name: course-categories
     ...
     */
    class CourseCategoriesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/course-categories';
    }