<?php
    ...
    /**
     * Class StudentGradePointAveragesClient
     *
     * StudentGradePointAveragesClient class used to interact with the `student-grade-point-averages` data type.
     * Domain: Student
     * Functional Area: Academic History - GPA
     * Model Name: student-grade-point-averages
     ...
     */
    class StudentGradePointAveragesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/student-grade-point-averages';
    }