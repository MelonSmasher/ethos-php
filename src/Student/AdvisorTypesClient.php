<?php
    ...
    /**
     * Class AdvisorTypesClient
     *
     * AdvisorTypesClient class used to interact with the `advisor-types` data type.
     * Domain: Student
     * Functional Area: Faculty - Advisors
     * Model Name: advisor-types
     ...
     */
    class AdvisorTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/advisor-types';
    }