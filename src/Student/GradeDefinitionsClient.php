<?php
    ...
    /**
     * Class GradeDefinitionsClient
     *
     * GradeDefinitionsClient class used to interact with the `grade-definitions` data type.
     * Domain: Student
     * Functional Area: Academic History - Section grades
     * Model Name: grade-definitions
     ...
     */
    class GradeDefinitionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/grade-definitions';
    }