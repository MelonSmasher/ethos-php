...
namespace MelonSmasher\EthosPHP\Admin;


use MelonSmasher\EthosPHP\EthosClient;

/**
 * Class AvailableResourcesClient
 *
 * AvailableResourcesClient class used to interact with the `available-resources` data type.
 * Domain: Admin
 * Model Name: available-resources
 ...
 *
 * @package MelonSmasher\EthosPHP\Admin
 * @license MIT
 * @license https://raw.githubusercontent.com/MelonSmasher/ethos-php/master/LICENSE MIT License
 * @author Alex Markessinis
 */
class AvailableResourcesClient extends EthosClient
{
    /**
     * API Version Banner
     *
     ...
     * @var string
     */
    protected $baseRoute = '/admin/available-resources';
}