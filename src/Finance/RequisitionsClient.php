<?php
    ...
    /**
     * Class RequisitionsClient
     *
     * RequisitionsClient class used to interact with the `requisitions` data type.
     * Domain: Finance
     * Functional Area: Purchasing and Procurement - Requisitions
     * Model Name: requisitions
     ...
     */
    class RequisitionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/requisitions';
    }