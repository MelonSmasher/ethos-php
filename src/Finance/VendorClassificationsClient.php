<?php
    ...
    /**
     * Class VendorClassificationsClient
     *
     * VendorClassificationsClient class used to interact with the `vendor-classifications` data type.
     * Domain: Finance
     * Functional Area: Accounts Payable - Vendors
     * Model Name: vendor-classifications
     ...
     */
    class VendorClassificationsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/vendor-classifications';
    }