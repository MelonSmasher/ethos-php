<?php
    ...
    /**
     * Class VendorContactsClient
     *
     * VendorContactsClient class used to interact with the `vendor-contacts` data type.
     * Domain: Finance
     * Functional Area: Accounts Payable - Vendors
     * Model Name: vendor-contacts
     ...
     */
    class VendorContactsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/vendor-contacts';
    }