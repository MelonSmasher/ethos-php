<?php
    ...
    /**
     * Class TaxFormsClient
     *
     * TaxFormsClient class used to interact with the `tax-forms` data type.
     * Domain: Finance
     * Functional Area: Accounts Payable - Invoices
     * Model Name: tax-forms
     ...
     */
    class TaxFormsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/tax-forms';
    }