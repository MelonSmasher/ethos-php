<?php
     ...
     * Class VendorsClient
     *
     * VendorsClient class used to interact with the `vendors` data type.
     * Domain: Finance
     ...
     * Colleague Data Model Versions Supported: 8, 11.1.0
     *
     ...
     */
    class VendorsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/vendors';
    }