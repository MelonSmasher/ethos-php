<?php
    ...
    /**
     * Class TaxFormComponentsClient
     *
     * TaxFormComponentsClient class used to interact with the `tax-form-components` data type.
     * Domain: Finance
     * Functional Area: Accounts Payable - Invoices
     * Model Name: tax-form-components
     ...
     */
    class TaxFormComponentsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/tax-form-components';
    }