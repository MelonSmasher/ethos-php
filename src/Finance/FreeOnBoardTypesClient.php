<?php
    ...
    /**
     * Class FreeOnBoardTypesClient
     *
     * FreeOnBoardTypesClient class used to interact with the `free-on-board-types` data type.
     * Domain: Finance
     * Functional Area: Purchasing and Procurement - Purchase Orders
     * Model Name: free-on-board-types
     ...
     */
    class FreeOnBoardTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/free-on-board-types';
    }