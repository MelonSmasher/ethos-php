<?php
    ...
    /**
     * Class ShippingMethodsClient
     *
     * ShippingMethodsClient class used to interact with the `shipping-methods` data type.
     * Domain: Finance
     * Functional Area: Purchasing and Procurement - Purchase Orders
     * Model Name: shipping-methods
     ...
     */
    class ShippingMethodsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/shipping-methods';
    }