<?php
    ...
    /**
     * Class FixedAssetTypesClient
     *
     * FixedAssetTypesClient class used to interact with the `fixed-asset-types` data type.
     * Domain: Finance
     * Functional Area: Fixed Assets - Fixed asset
     * Model Name: fixed-asset-types
     ...
     */
    class FixedAssetTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/fixed-asset-types';
    }