<?php
    ...
    /**
     * Class FiscalYearsClient
     *
     * FiscalYearsClient class used to interact with the `fiscal-years` data type.
     * Domain: Finance
     * Functional Area: General Ledger - Fiscal Year and Fiscal Month
     * Model Name: fiscal-years
     ...
     */
    class FiscalYearsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/fiscal-years';
    }