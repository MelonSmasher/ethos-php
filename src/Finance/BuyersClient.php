<?php
     ...
     * Class BuyersClient
     *
     * BuyersClient class used to interact with the `buyers` data type.
     * Domain: Finance
     * Functional Area: Purchasing and Procurement - Buyers
     * Model Name: buyers
     ...
     */
    class BuyersClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/buyers';
    }