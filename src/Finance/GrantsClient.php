<?php
     ...
     * Class GrantsClient
     *
     * GrantsClient class used to interact with the `grants` data type.
     * Domain: Finance
     * Functional Area: Projects Accounting - Grants
Research Accounting - Grants
     ...
     */
    class GrantsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/grants';
    }