<?php
    ...
    /**
     * Class AccountingStringsClient
     *
     * AccountingStringsClient class used to interact with the `accounting-strings` data type.
     * Domain: Finance
     * Functional Area: General Ledger - GL Accounts
     * Model Name: accounting-strings
     ...
     */
    class AccountingStringsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/accounting-strings';
    }