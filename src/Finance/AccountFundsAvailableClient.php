<?php
    ...
    /**
     * Class AccountFundsAvailableClient
     *
     * AccountFundsAvailableClient class used to interact with the `account-funds-available` data type.
     * Domain: Finance
     * Functional Area: General Ledger - Available Balance/NSF Checking
     * Model Name: account-funds-available
     ...
     */
    class AccountFundsAvailableClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/account-funds-available';
    }