<?php
    ...
    /**
     * Class ExternalEmploymentsClient
     *
     * ExternalEmploymentsClient class used to interact with the `external-employments` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Applicants
     * Model Name: external-employments
     ...
     */
    class ExternalEmploymentsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/external-employments';
    }