<?php
    ...
    /**
     * Class EmploymentProficiencyLevelsClient
     *
     * EmploymentProficiencyLevelsClient class used to interact with the `employment-proficiency-levels` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Candidate
     * Model Name: employment-proficiency-levels
     ...
     */
    class EmploymentProficiencyLevelsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/employment-proficiency-levels';
    }