<?php
    ...
    /**
     * Class EmployeeLeavePlansClient
     *
     * EmployeeLeavePlansClient class used to interact with the `employee-leave-plans` data type.
     * Domain: Human Resources
     * Functional Area: Personnel - Leave
     * Model Name: employee-leave-plans
     ...
     */
    class EmployeeLeavePlansClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/employee-leave-plans';
    }