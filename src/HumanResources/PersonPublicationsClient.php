<?php
    ...
    /**
     * Class PersonPublicationsClient
     *
     * PersonPublicationsClient class used to interact with the `person-publications` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Candidate
     * Model Name: person-publications
     ...
     */
    class PersonPublicationsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/person-publications';
    }