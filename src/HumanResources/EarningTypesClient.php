<?php
    ...
    /**
     * Class EarningTypesClient
     *
     * EarningTypesClient class used to interact with the `earning-types` data type.
     * Domain: Human Resources
     * Functional Area: Personnel - Time and attendance
     * Model Name: earning-types
     ...
     */
    class EarningTypesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/earning-types';
    }