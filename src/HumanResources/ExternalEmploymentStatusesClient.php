<?php
    ...
    /**
     * Class ExternalEmploymentStatusesClient
     *
     * ExternalEmploymentStatusesClient class used to interact with the `external-employment-statuses` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Applicants
     * Model Name: external-employment-statuses
     ...
     */
    class ExternalEmploymentStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/external-employment-statuses';
    }