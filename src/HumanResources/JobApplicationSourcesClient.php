<?php
    ...
    /**
     * Class JobApplicationSourcesClient
     *
     * JobApplicationSourcesClient class used to interact with the `job-application-sources` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Applications
     * Model Name: job-application-sources
     ...
     */
    class JobApplicationSourcesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/job-application-sources';
    }