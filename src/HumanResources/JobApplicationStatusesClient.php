<?php
    ...
    /**
     * Class JobApplicationStatusesClient
     *
     * JobApplicationStatusesClient class used to interact with the `job-application-statuses` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Applications
     * Model Name: job-application-statuses
     ...
     */
    class JobApplicationStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/job-application-statuses';
    }