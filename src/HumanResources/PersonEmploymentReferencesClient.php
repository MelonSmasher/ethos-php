<?php
    ...
    /**
     * Class PersonEmploymentReferencesClient
     *
     * PersonEmploymentReferencesClient class used to interact with the `person-employment-references` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Candidate
     * Model Name: person-employment-references
     ...
     */
    class PersonEmploymentReferencesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/person-employment-references';
    }