<?php
    ...
    /**
     * Class EmployeeLeaveTransactionsClient
     *
     * EmployeeLeaveTransactionsClient class used to interact with the `employee-leave-transactions` data type.
     * Domain: Human Resources
     * Functional Area: Personnel - Leave
     * Model Name: employee-leave-transactions
     ...
     */
    class EmployeeLeaveTransactionsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/employee-leave-transactions';
    }