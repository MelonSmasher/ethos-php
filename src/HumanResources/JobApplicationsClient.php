<?php
    ...
    /**
     * Class JobApplicationsClient
     *
     * JobApplicationsClient class used to interact with the `job-applications` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Applications
     * Model Name: job-applications
     ...
     */
    class JobApplicationsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/job-applications';
    }