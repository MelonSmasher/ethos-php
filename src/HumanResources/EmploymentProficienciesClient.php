<?php
    ...
    /**
     * Class EmploymentProficienciesClient
     *
     * EmploymentProficienciesClient class used to interact with the `employment-proficiencies` data type.
     * Domain: Human Resources
     * Functional Area: Hiring - Applicants
     * Model Name: employment-proficiencies
     ...
     */
    class EmploymentProficienciesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/employment-proficiencies';
    }