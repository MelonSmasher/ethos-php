<?php
    ...
    /**
     * Class EmploymentLeaveOfAbsenceReasonsClient
     *
     * EmploymentLeaveOfAbsenceReasonsClient class used to interact with the `employment-leave-of-absence-reasons` data type.
     * Domain: Human Resources
     * Functional Area: Personnel - Employee Positions
     * Model Name: employment-leave-of-absence-reasons
     ...
     */
    class EmploymentLeaveOfAbsenceReasonsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/employment-leave-of-absence-reasons';
    }