<?php
    ...
    /**
     * Class LeaveCategoriesClient
     *
     * LeaveCategoriesClient class used to interact with the `leave-categories` data type.
     * Domain: Human Resources
     * Functional Area: Personnel - Leave
     * Model Name: leave-categories
     ...
     */
    class LeaveCategoriesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/leave-categories';
    }