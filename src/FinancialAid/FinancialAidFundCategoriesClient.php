<?php
    ...
    /**
     * Class FinancialAidFundCategoriesClient
     *
     * FinancialAidFundCategoriesClient class used to interact with the `financial-aid-fund-categories` data type.
     * Domain: Financial Aid
     * Functional Area: Awards - FA Awards
     * Model Name: financial-aid-fund-categories
     ...
     */
    class FinancialAidFundCategoriesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/financial-aid-fund-categories';
    }