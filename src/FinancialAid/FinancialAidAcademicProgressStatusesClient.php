<?php
    ...
    /**
     * Class FinancialAidAcademicProgressStatusesClient
     *
     * FinancialAidAcademicProgressStatusesClient class used to interact with the `financial-aid-academic-progress-statuses` data type.
     * Domain: Financial Aid
     * Functional Area: Status - Satisfactory Academic Progress (SAP)
     * Model Name: financial-aid-academic-progress-statuses
     ...
     *
     * @package MelonSmasher\EthosPHP\FinancialAid
     * @license MIT
     * @license https://raw.githubusercontent.com/MelonSmasher/ethos-php/master/LICENSE MIT License
     * @author Alex Markessinis
     */
    class FinancialAidAcademicProgressStatusesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/financial-aid-academic-progress-statuses';
    }