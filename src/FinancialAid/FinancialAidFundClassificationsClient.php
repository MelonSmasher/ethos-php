<?php
    ...
    /**
     * Class FinancialAidFundClassificationsClient
     *
     * FinancialAidFundClassificationsClient class used to interact with the `financial-aid-fund-classifications` data type.
     * Domain: Financial Aid
     * Functional Area: Awards - FA Awards
     * Model Name: financial-aid-fund-classifications
     ...
     */
    class FinancialAidFundClassificationsClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/financial-aid-fund-classifications';
    }