<?php
    ...
    /**
     * Class FinancialAidOfficesClient
     *
     * FinancialAidOfficesClient class used to interact with the `financial-aid-offices` data type.
     * Domain: Financial Aid
     * Functional Area: Awards - FA Awards
     * Model Name: financial-aid-offices
     ...
     */
    class FinancialAidOfficesClient extends EthosClient
    {
        /**
         * API Version Banner
         *
         ...
         * @var string
         */
        protected $baseRoute = '/api/financial-aid-offices';
    }