...
namespace MelonSmasher\EthosPHP\Util;
 ...
 *
 * AppconfigClient class used to interact with the `appconfig` data type.
 * Domain: Admin
 * Model Name: appconfig
 ...
 */
class AppconfigClient extends EthosClient
{
    /**
     * API Version Banner
     *
